...
export function initReliability() {
    const canvas = document.getElementById('p1-chart');
    const horizSlider = document.getElementById('p1-horizon');
    const horizVal = document.getElementById('p1-horizon-val');
    const metricsDiv = document.getElementById('p1-metrics');
    const modeInputs = document.querySelectorAll('input[name="p1-mode"]');
    function getMode() {
