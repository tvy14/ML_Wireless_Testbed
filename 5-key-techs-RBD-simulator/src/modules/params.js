...
export const TIME_AXIS = Array.from({ length: N_STEPS }, (_, i) => (i / (N_STEPS - 1)) * T_MAX);
...
export function componentReliability(lambda, t) {
    return Math.exp(-lambda * t);
}
// k-out-of-n system reliability
export function systemReliability(p, t) {
