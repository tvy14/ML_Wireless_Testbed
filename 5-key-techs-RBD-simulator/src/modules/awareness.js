...
function anomalyScore(rActual, noise, rand) {
...
function confidence(score, theta) {
    return 1 - Math.min(1, score / theta);
}
export function initAwareness() {
    const canvas = document.getElementById('p2-chart');
    const seedSlider = document.getElementById('p2-seed');
    const noiseSlider = document.getElementById('p2-noise');
    const saiMinSlider = document.getElementById('p2-saimin');
    const seedVal = document.getElementById('p2-seed-val');
    const noiseVal = document.getElementById('p2-noise-val');
    const saiMinVal = document.getElementById('p2-saimin-val');
    const metricsDiv = document.getElementById('p2-metrics');
    function render() {
        ...
        const datasets = [];
        const saiData = new Array(TIME_AXIS.length).fill(0);
